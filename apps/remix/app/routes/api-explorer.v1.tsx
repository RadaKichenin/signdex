...
export const meta: MetaFunction = () => {
  return [
    { title: 'API v1 Documentation - Documenso' },
    { name: 'description', content: 'Explore Documenso API v1 with interactive documentation' },
  ];
};
...
export default function ApiExplorerV1() {
  const apiUrl = `${NEXT_PUBLIC_WEBAPP_URL()}/api/v1/openapi`;
        ...
        <div className="container mx-auto flex items-center justify-between px-4 py-4">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-lg font-semibold">API v1 Documentation</h1>
            </div>
          </div>
          <a
            href="/"
